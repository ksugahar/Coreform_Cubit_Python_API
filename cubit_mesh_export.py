			...
			for surface_id in surface_list:
				...
				if len(quad_list)>0:
					for quad_id in quad_list:
						...
						fid.write(f'{Elems} {3} {3} {nodeset_id} {surface_id} {4} {node_list[0]} {node_list[1]} {node_list[2]} {node_list[3]}\n')
				tri_list = cubit.get_surface_tris(surface_id)
				if len(tri_list)>0:
					for tri_id in tri_list:
						Elems += 1
						node_list = cubit.get_connectivity("tri", tri_id)
						fid.write(f'{Elems} {2} {3} {nodeset_id} {surface_id} {3} {node_list[0]} {node_list[1]} {node_list[2]}\n')
			...
			for volume_id in volume_list:
				...
				if len(hex_list)>0:
					for hex_id in hex_list:
						...
						fid.write(f'{Elems} {5} {3} {block_id} {volume_id} {8} {node_list[0]} {node_list[1]} {node_list[2]} {node_list[3]} {node_list[4]} {node_list[5]} {node_list[6]} {node_list[7]}\n')
				...
				if len(tet_list)>0:
					for tet_id in tet_list:
						Elems += 1
						node_list = cubit.get_connectivity("tet", tet_id)
						fid.write(f'{Elems} {4} {3} {block_id} {volume_id} {4} {node_list[0]} {node_list[1]} {node_list[2]} {node_list[3]}\n')
				...
				if len(wedge_list)>0:
					for wedge_id in wedge_list:
						...
						fid.write(f'{Elems} {6} {3} {block_id} {volume_id} {6} {node_list[0]} {node_list[1]} {node_list[2]} {node_list[3]} {node_list[4]} {node_list[5]}\n')
				...
				if len(pyramid_list)>0:
					for pyramid_id in pyramid_list:
						...
						fid.write(f'{Elems} {7} {3} {block_id} {volume_id} {5} {node_list[0]} {node_list[1]} {node_list[2]} {node_list[3]} {node_list[4]}\n')
